...
public class OkHttpClientManager {
	...
	public static void post(String url, String bodyStr,
			final ResultCallback callback) throws IOException {
	...
	public class PostDelegate {
		...
		public void postAsyn(String url, String bodyStr,
				final ResultCallback callback) {
			postAsyn(url, bodyStr, MediaType.parse("text/plain;charset=utf-8"),
					callback);
		}
		 ...
		 * 直接将bodyStr以写入请求体
		 */
		public void postAsyn(String url, String bodyStr, MediaType type,
				final ResultCallback callback) {
		 ...
		 * 直接将bodyFile以写入请求体
		 */
		public void postAsyn(String url, File bodyFile, MediaType type,
				final ResultCallback callback) {
		 ...
		 * 直接将bodyBytes以写入请求体
		 */
		public void postAsyn(String url, byte[] bodyBytes, MediaType type,
				final ResultCallback callback) {
	...
	public class UploadDelegate {
		...
		public void postAsyn(String url, String[] fileKeys, File[] files,
				Param[] params, ResultCallback callback) {
			Request request = buildMultipartFormRequest(url, files, fileKeys,
					params);
			deliveryResult(callback, request);
		}
